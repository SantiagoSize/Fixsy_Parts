    ...
    <div className="user-modal-overlay" role="dialog" aria-modal="true" onClick={onClose}>
      <div className="user-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="actions" style={{ justifyContent: 'center' }}>
          <button onClick={() => onUpdate(user.id, { status: "Bloqueado" }, "Usuario bloqueado")}>Bloquear</button>
          ...
          <button onClick={() => onUpdate(user.id, { status: "Activo", suspensionHasta: "" }, "Usuario reactivado")}>Reactivar</button>
        </div>
